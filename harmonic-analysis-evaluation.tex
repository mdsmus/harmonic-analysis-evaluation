...
\end{tabular}
\caption{Chord labels used in this article and their occurences in our
corpus}
\label{tab:legenda}
\end{table}
...
The performance Pardo and Birmingham's original algorithm , \texttt{S-pb}, is
very low on our corpus due to the variety of chord types
considered. For this reason it has the highest recall on major chords,
major chords with a minor seventh, and half-diminished chords.

The decision tree algorithm's performance is unremarkable. It displays
the smallest hability to generalize from training data of our machine
...
tones. This suggestes that an enhanced pattern matcher supporting
