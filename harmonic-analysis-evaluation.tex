...
\begin{abstract}
  ...
  and suggest, for example, how is it better \note{``better ways'' is
    better IMHO} to increment our training corpus. The evaluation is
  performed on Bach chorales. \note{merge com 1o paragrafo}
